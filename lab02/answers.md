...
```python
stellan@minttu:~//TFRE40$ /bin/python3 /home/stellan/src/py/TFRE40/lab02/hello.py
hello world
```
...
The relevant part of the [source code](pythagoras.py) is defined by the following code block:
```python
